...
Future<NewCalendarModel> getAppointmentByDate(
    HttpClient httpClient, DateTime date) async {
  if (httpClient == null) {
    return null;
  }

  final unixDate =
      date.millisecondsSinceEpoch == null ? null : date.millisecondsSinceEpoch;

//  final response = await httpClient.client.get("/appointments/$unixDate");

  final response =
      await http.get('http://www.mocky.io/v2/5daac2863100002d00becd9e');
